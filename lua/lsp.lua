...
do -- keymaps
	...
	set_keymap("n", pfx("="), function()
		vim.lsp.buf.format({ async = true })
	end, opts)

	set_keymap("n", pfx("n"), function()
		require("illuminate").next_reference({ wrap = true })
	end, opts)
	set_keymap("n", pfx("p"), function()
...
local on_attach = function(client, bufnr)
	...
	if client.supports_method(vim.lsp.protocol.Methods.textDocument_signatureHelp) then
		client.handlers["textDocument/signatureHelp"] = vim.lsp.buf.signature_help({ border = "rounded" })
	end
