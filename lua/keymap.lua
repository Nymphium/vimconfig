...
vim.api.nvim_set_keymap('n', '<ESC>', '<ESC><ESC>:nohlsearch<CR>',
  { silent = true, noremap = true, desc = 'Clear search highlighting' })
vim.api.nvim_set_keymap('n', '<M-s>', '<ESC>:w!<CR>', { noremap = true, silent = true, desc = 'Save file' })
vim.api.nvim_set_keymap('n', '<M-s><M-s>', '<ESC>:wq!<CR>', { noremap = true, silent = true, desc = 'Save and quit' })
vim.api.nvim_set_keymap('n', '<C-q>', '<cmd>bd!<CR>', { noremap = true, silent = true, desc = 'Close buffer' })
vim.api.nvim_set_keymap('n', '<C-w><C-w>', '<cmd>q!<CR>',
  { noremap = true, silent = true, desc = 'Quit without saving' })
vim.api.nvim_set_keymap('n', '<Left>', '<C-w><Left>',
  { noremap = true, silent = true, desc = 'Move to window on the left' })
vim.api.nvim_set_keymap('n', '<Right>', '<C-w><Right>',
  { noremap = true, silent = true, desc = 'Move to window on the right' })
vim.api.nvim_set_keymap('n', '<Up>', '<C-w><Up>', { noremap = true, silent = true, desc = 'Move to window above' })
vim.api.nvim_set_keymap('n', '<Down>', '<C-w><Down>', { noremap = true, silent = true, desc = 'Move to window below' })
vim.api.nvim_set_keymap('n', '<M-w>', 'b', { noremap = true, silent = true, desc = 'Move to previous word' })
vim.api.nvim_set_keymap('n', '<M-e>', 'w', { noremap = true, silent = true, desc = 'Move to next word' })
vim.api.nvim_set_keymap('n', '<BS>', 'X', { noremap = true, silent = true, desc = 'Delete character before cursor' })
vim.api.nvim_set_keymap('n', '<M-1>', '<C-x>', { noremap = true, silent = true, desc = 'Decrement number under cursor' })
vim.api.nvim_set_keymap('n', '<M-2>', '<C-a>', { noremap = true, silent = true, desc = 'Increment number under cursor' })
vim.api.nvim_set_keymap('n', 'j', 'gj', { noremap = true, silent = true, desc = 'Move down by visual line' })
vim.api.nvim_set_keymap('n', 'k', 'gk', { noremap = true, silent = true, desc = 'Move up by visual line' })
vim.api.nvim_set_keymap('n', 'r', '<C-r>', { noremap = true, silent = true, desc = 'Redo' })
vim.api.nvim_set_keymap('n', '<C-r>', 'r', { noremap = true, silent = true, desc = 'Replace character under cursor' })
...
vim.api.nvim_set_keymap('n', '<C-h>', '<C-w>h', { noremap = true, silent = true, desc = 'Move to window on the left' })
...
vim.api.nvim_set_keymap('n', '<C-l>', '<C-w>l', { noremap = true, silent = true, desc = 'Move to window on the right' })
